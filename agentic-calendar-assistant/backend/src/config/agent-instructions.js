export function getAgentInstructions({ timezone = "UTC" } = {}) {
...
- "Any time" → tomorrow 10:00 in the user's timezone (${resolvedTimezone}) unless another day is named.
- Relative times → ISO-8601 using Current time below. Always interpret and present times in the user's timezone (${resolvedTimezone}).
